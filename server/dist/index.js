...
var dictionaryPromise = readFileAsync('/usr/share/dict/words', { encoding: 'utf-8' });
...
app.get('/words', function () { return __awaiter(void 0, void 0, void 0, function () {
    var dictionary;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, dictionaryPromise];
            case 1:
                dictionary = _a.sent();
...
app.listen(3000, function (_, err) {
