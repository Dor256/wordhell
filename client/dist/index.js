...
{
	if (region.a3.av === region.bk.av)
	{
		return 'on line ' + region.a3.av;
	}
	return 'on lines ' + region.a3.av + ' through ' + region.bk.av;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b8: 'hidden', b1: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b8: 'mozHidden', b1: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b8: 'msHidden', b1: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b8: 'webkitHidden', b1: 'webkitvisibilitychange' }
		: { b8: 'hidden', b1: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.cd, request.cw, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.cw));
		}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bn: fragment, bq: host, by: path, bA: port_, bD: protocol, bE: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bZ: false, b0: r.b0, b6: r.b6, bo: r.bo, cd: r.cd, cs: r.cs, bQ: r.bQ, cw: r.cw}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{b0: $elm$http$Http$emptyBody, b6: r.b6, bo: _List_Nil, cd: 'GET', cs: $elm$core$Maybe$Nothing, bQ: $elm$core$Maybe$Nothing, cw: r.cw});
};
var $author$project$Api$fetchWord = function (msg) {
	return $elm$http$Http$get(
		{
			b6: $elm$http$Http$expectString(msg),
			cw: $author$project$Api$baseUrl + '/word'
		});
};
...
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$LocalStorage$loadString($author$project$Main$Load);
};
var $elm$core$String$cons = _String_cons;
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {X: charsProcessed, ac: hash, R: seed, ah: shift};
	});
...
var $robinheghan$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.ac | ((255 & $elm$core$Char$toCode(c)) << data.ah);
		var _v0 = data.ah;
		if (_v0 === 24) {
			return {
				X: data.X + 1,
			...
			return {X: data.X + 1, ac: res, R: data.R, ah: data.ah + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$row = {aX: 0, as: 0, z: 'row'};
...
var $rtfeldman$elm_css$Css$prop4 = F5(
	function (key, argA, argB, argC, argD) {
		return A2($rtfeldman$elm_css$Css$property, key, argA.z + (' ' + (argB.z + (' ' + (argC.z + (' ' + argD.z))))));
	});
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.b2) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.cf, record.b2, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bh: charset, b3: declarations, br: imports, bw: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bh: $elm$core$Maybe$Nothing, br: _List_Nil, bw: _List_Nil, bM: snippets};
};
...
var $author$project$Elements$letter = A2(
	$rtfeldman$elm_css$Html$Styled$styled,
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			...
			A3($rtfeldman$elm_css$Css$rgb, 194, 0, 0)),
...
var $rtfeldman$elm_css$Css$absolute = {ax: 0, z: 'absolute'};
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Html$Styled$text(model.aU),
						$rtfeldman$elm_css$Html$Styled$text('load'),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A2($author$project$Elements$letter, _List_Nil, _List_Nil),
								A2($author$project$Elements$letter, _List_Nil, _List_Nil),
								A2($author$project$Elements$letter, _List_Nil, _List_Nil),
								A2($author$project$Elements$letter, _List_Nil, _List_Nil),
								A2($author$project$Elements$letter, _List_Nil, _List_Nil)
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		cr: $author$project$Main$subscriptions,
		cu: $author$project$Main$update,
		cx: A2($elm$core$Basics$composeR, $author$project$Main$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
